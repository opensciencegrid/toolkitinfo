...
<div class="navbar">
    <div class="form">
      ...
      <input type="submit" value="Submit" onload="setcustom()">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content" id="pSDocs">
      <div class="tooltip" id="OSG-net-docs">
        <span class="tooltiptext">This takes you to the OSG networking area documentation"</span>
        <a href="https://opensciencegrid.org/networking/" target="_blank">OSG Networking Area Documentation</a>
      </div><br>
      <div class="tooltip" id="pS-docs">
        <span class="tooltiptext">This takes you to the perfSONAR Toolkit documentation"</span>
        <a href="https://docs.perfsonar.net/" target="_blank">perfSONAR Toolkit Documentation</a>
      </div><br>
      <div class="tooltip" id="ES-Fasterdata">
        <span class="tooltiptext">This takes you to the ESnet Fasterdata homepage"</span>
        <a href="http://fasterdata.es.net/" target="_blank">ESnet Fasterdata Home (Network/system Tuning)</a>
      </div><br>
      <div class="tooltip" id="ES-trouble">
        <span class="tooltiptext">This takes you to the ESnet troubleshooting page"</span>
        <a href="https://fasterdata.es.net/performance-testing/troubleshooting/network-troubleshooting-quick-reference-guide/" target="_blank">ESnet Network Troubleshooting Guide</a>
      </div><br>
    </div>
  </div>
  <div class="dropdown">
...
<!--      <div class="tooltip" id="pS-collector">
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content" id="pSAlarms">
      <div class="tooltip" id="PL-alarm">
        <span class="tooltiptext">This is the Kibana dashboard at UC for packet-loss alarms"</span>
        <a href="https://atlas-kibana.mwt2.org/s/networking/app/kibana#/dashboard/Perfsonar-Alarms?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-24h,mode:quick,to:now))&_a=(description:'',filters:!(),fullScreenMode:!f,options:(darkTheme:!t),panels:!((gridData:(h:20,i:'1',w:24,x:0,y:0),id:Perfsonar-alarms-bad-packet-loss-destinations,panelIndex:'1',type:visualization,version:'6.8.0'),(gridData:(h:20,i:'2',w:24,x:24,y:0),id:Perfsonar-alarms-bad-packet-loss-sources,panelIndex:'2',type:visualization,version:'6.8.0'),(embeddableConfig:(vis:(params:(sort:(columnIndex:!n,direction:!n)))),gridData:(h:25,i:'3',w:32,x:0,y:20),id:Perfsonar-alarms-bad-packet-loss-table,panelIndex:'3',type:visualization,version:'6.8.0')),query:(language:lucene,query:(query_string:(analyze_wildcard:!t,default_field:'*',lowercase_expanded_terms:!f,query:'*'))),timeRestore:!t,title:'Perfsonar%20Alarms',viewMode:view)" target="_blank">Packet Loss Alarms</a>
      </div><br>
      <div class="tooltip" id="PL-overview">
        <span class="tooltiptext">This is the Kibana dashboard at UC for packet-loss overview"</span>
	<a href="https://atlas-kibana.mwt2.org/s/networking/app/kibana#/dashboard/f7c4cb80-31b2-11e9-9a8d-07fa5dee6891?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-24h,mode:quick,to:now))&_a=(description:'This%20dashboard%20is%20used%20to%20give%20an%20overview%20visualizations%20of%20Ps%20packet%20loss.',filters:!(),fullScreenMode:!f,options:(darkTheme:!f,hidePanelTitles:!f,useMargins:!t),panels:!((embeddableConfig:(),gridData:(h:4,i:'10',w:27,x:0,y:0),id:'9dfe1dd0-349c-11e9-9a8d-07fa5dee6891',panelIndex:'10',title:'ps%20packet%20loss%20tab',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:17,i:'16',w:48,x:0,y:28),id:'90f58440-3c6a-11e9-9a8d-07fa5dee6891',panelIndex:'16',title:'packet%20loss%20table',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:9,i:'18',w:14,x:34,y:19),id:b5cc1ff0-3c73-11e9-9a8d-07fa5dee6891,panelIndex:'18',title:'top%205%20average%20packet%20loss%20(src%20host)',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:8,i:'19',w:14,x:34,y:11),id:'4c185740-3c73-11e9-9a8d-07fa5dee6891',panelIndex:'19',title:'top%205%20average%20packet%20loss%20(dest%20host)',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:11,i:'20',w:21,x:27,y:0),id:'947c5f30-5362-11e9-9a8d-07fa5dee6891',panelIndex:'20',title:'ps%20packet%20loss%20instruction',type:visualization,version:'6.5.0'),(embeddableConfig:(vis:(legendOpen:!t)),gridData:(h:17,i:'22',w:24,x:0,y:11),id:f81e41b0-53d6-11e9-9a8d-07fa5dee6891,panelIndex:'22',title:'packet%20loss%20(min,%20max,%20average)',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:8,i:'23',w:10,x:24,y:11),id:a5f06fb0-53d8-11e9-9a8d-07fa5dee6891,panelIndex:'23',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:9,i:'24',w:10,x:24,y:19),id:d9a26250-53d8-11e9-9a8d-07fa5dee6891,panelIndex:'24',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:7,i:'25',w:27,x:0,y:4),id:'612da5b0-31f9-11e9-9a8d-07fa5dee6891',panelIndex:'25',type:visualization,version:'6.5.0')),query:(language:lucene,query:''),timeRestore:!f,title:ps_packet_loss_overview,viewMode:view)" target="_blank">Packet Loss Overview</a>
      </div><br>
      <div class="tooltip" id="PL-topN">
        <span class="tooltiptext">This is the Kibana dashboard at UC for packet-loss Top-N occurrences"</span>
    	<a href="https://atlas-kibana.mwt2.org/s/networking/app/kibana#/dashboard/c3e33cf0-349d-11e9-9a8d-07fa5dee6891?_g=(refreshInterval:(pause:!t,value:0),time:(from:now-24h,mode:quick,to:now))&_a=(description:'This%20dashboard%20is%20used%20to%20visualize%20the%20src%20hosts%20and%20dest%20hosts%20that%20are%20with%20the%20highest%20packet%20loss.',filters:!(),fullScreenMode:!f,options:(darkTheme:!f,hidePanelTitles:!f,useMargins:!t),panels:!((embeddableConfig:(),gridData:(h:12,i:'8',w:12,x:20,y:4),id:'584e7580-31fb-11e9-9a8d-07fa5dee6891',panelIndex:'8',title:'top%2010%20sum%20of%20packet%20loss%20(src%20host)',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:4,i:'11',w:32,x:0,y:0),id:'9dfe1dd0-349c-11e9-9a8d-07fa5dee6891',panelIndex:'11',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:11,i:'12',w:12,x:20,y:16),id:'7ca32540-4d06-11e9-9a8d-07fa5dee6891',panelIndex:'12',title:'top%2010%20sum%20of%20packet%20loss%20(dest%20host)',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:11,i:'14',w:20,x:0,y:16),id:'30f86c70-53d4-11e9-9a8d-07fa5dee6891',panelIndex:'14',title:'top%2010%20packet%20loss%20(dest%20host)',type:visualization,version:'6.5.0'),(embeddableConfig:(),gridData:(h:12,i:'15',w:20,x:0,y:4),id:'7dc02f70-53d4-11e9-9a8d-07fa5dee6891',panelIndex:'15',title:'top%2010%20packet%20loss%20(src%20host)',type:visualization,version:'6.5.0')),query:(language:lucene,query:''),timeRestore:!f,title:ps_packet_loss_top-N,viewMode:view)" target="_blank">Packet Loss Top-N</a>
      </div><br>
    </div>
  </div> 
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content" id="pSServices">
      <div class="tooltip" id="MaDDash">
        <span class="tooltiptext">This takes you to the OSG MaDDash webpage"</span>
        <a href="https://psmad.opensciencegrid.org/maddash-webui/index.cgi" target="_blank">OSG//WLCG MaDDash</a>
      </div><br>   
      <div class="tooltip" id="pSConfig">
        <span class="tooltiptext">This takes you to the OSG/WLCG central perfSONAR toolkit configuration page"</span>
        <a href="https://psconfig.opensciencegrid.org/" target="_blank">OSG/WLCG pSConfig (PWA)</a>
      </div><br>
      <div class="tooltip" id="psetf">
        <span class="tooltiptext">This takes you to the ETF service monitoring page for OSG/WLCG perfSONARs"</span>
        <a href="https://psetf.opensciencegrid.org/etf/check_mk/" target="_blank">OSG/WLCG psetf (check_mk) monitoring</a>
      </div><br>
    </div>
  </div>
  ...
  <div class="dropdown">
    ...
    <div class="dropdown-content" id="pSAnalytics">
      ...
      <div class="tooltip" id="SAND">
        ...
        <a href="https://sand-ci.org/" target="_blank">The SAND Project</a> focused on networking analytics for OSG and WLCG
      </div><br>
      <div class="tooltip" id="MEPHI-tr">
        <span class="tooltiptext">This takes you to our MEPHI collaborators traceroute visualization tool for OSG/WLCG perfSONAR traceroutes"</span>
        <a href="https://perfsonar.uc.ssl-hep.org/graph/viewer" target="_blank">The MEPHI Traceroute Visualizer</a> using our OSG/WLCG traceroute measurements
      </div><br>
    </div>
  </div>
