...
This toolkit's settings and status  <a href="https://<?php echo $_GET["toolkits"]; ?>/toolkit/services/host.cgi?method=get_summary">Details</a><br>
  ...
  <footer>
        <a style="float: left;padding: 30px 10px;" href="mailto:wlcg-perfsonar-support@cern.ch?subject=ToolkitInfoFeedback">Contact about the webpage</a>
        <center>      
        ...
        <a style="float: right;padding: 30px 10px;" href="mailto:wlcg-perfsonar-support@cern.ch?subject=ToolkitInfoFeedback">Contact about the webpage</a>
  </footer>
