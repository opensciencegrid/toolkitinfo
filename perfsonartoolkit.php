...
-->
 ...
 <h4> Links for all toolkits: </h4>
  <div class='row'>
   <div class='column'>
    <a href=https://<?php echo htmlspecialchars($_GET[host]); ?>/toolkit target='_blank'><button class='block'>See All Information About <?php echo $savedcookie; ?></button></a>
    <br> </br> 
   </div>
  </div>
 </div>
 ...
 <div class='row'>
  <div class='column'>
   <a href=https://atlas-kibana.mwt2.org:5601/s/networking/app/dashboards#/view/07a03a80-beda-11e9-96c8-d543436ab024?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-4h,to:now))&_a=(description:'Visualizations%20and%20metrics%20for%20measurement%20of%20packet%20loss%20from%20the%20OSG%2FWLCG%20perfSONAR%20network%20monitoring%20infrastructure.',filters:!(),fullScreenMode:!f,options:(darkTheme:!f,hidePanelTitles:!f,useMargins:!t),query:(language:lucene,query:'(src_host:<?php echo htmlspecialchars($_GET[host]); ?>%20AND%20dest_host:*)%20OR%20(src_host:*%20AND%20dest_host:<?php echo htmlspecialchars($_GET[host]); ?>)'),tags:!(),timeRestore:!f,title:'Overview%20of%20%20Packet%20Loss%20in%20OSG%2FWLCG',viewMode:view) target='_blank'><button class='block'>Information about your host's Packetloss</button></a>
   <br> </br>
   <a href=https://atlas-kibana.mwt2.org:5601/s/networking/app/dashboards#/view/58121420-5e17-11ea-bad0-ff3d06e7229e?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-4h,to:now))&_a=(description:'This%20dashboard%20tries%20to%20summarize%20the%20perfSONAR%20traceroute%20information%20from%20the%20OSG%2FWLCG%20infrastructure.',filters:!(),fullScreenMode:!f,options:(hidePanelTitles:!f,useMargins:!t),query:(language:kuery,query:'(src_host:<?php echo htmlspecialchars($_GET[host]); ?>%20AND%20dest_host:*)%20OR%20(src_host:*%20AND%20dest_host:<?php echo htmlspecialchars($_GET[host]); ?>)'),tags:!(),timeRestore:!f,title:'Overview%20of%20Traceroute',viewMode:view) target='_blank'><button class='block'>Information about your host's Traceroute</button></a>
   <br> </br>
  </div>
  <div class='column'>
   <a href=https://atlas-kibana.mwt2.org:5601/s/networking/app/dashboards#/view/ab7c4950-5cfa-11ea-bad0-ff3d06e7229e?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-4h,to:now))&_a=(description:'Visualizations%20and%20metrics%20for%20measurement%20of%20throughput%20from%20the%20OSG%2FWLCG%20perfSONAR%20network%20monitoring%20infrastructure.',filters:!(),fullScreenMode:!f,options:(darkTheme:!f,hidePanelTitles:!f,useMargins:!t),query:(language:lucene,query:'(src_host:<?php echo htmlspecialchars($_GET[host]); ?>%20AND%20dest_host:*)%20OR%20(src_host:*%20AND%20dest_host:<?php echo htmlspecialchars($_GET[host]); ?>)'),tags:!(),timeRestore:!f,title:'Overview%20of%20Throughput%20in%20OSG%2FWLCG',viewMode:view) target='_blank'><button class='block'>Information about your host's Throughput</button></a>
   <br> </br>
   <a href=https://atlas-kibana.mwt2.org:5601/s/networking/app/dashboards#/view/dc2879e0-d115-11ea-9344-2da4788d78a4?_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-4h,to:now))&_a=(description:'Visualizations%20and%20metrics%20for%20measurement%20of%20OWD%20from%20the%20OSG%2FWLCG%20perfSONAR%20network%20monitoring%20infrastructure.',filters:!(),fullScreenMode:!f,options:(darkTheme:!f,hidePanelTitles:!f,useMargins:!t),query:(language:lucene,query:'(src_host:<?php echo htmlspecialchars($_GET[host]); ?>%20AND%20dest_host:*)%20OR%20(src_host:*%20AND%20dest_host:<?php echo htmlspecialchars($_GET[host]); ?>)'),tags:!(),timeRestore:!t,title:'Overview%20of%20%20OWD%20in%20OSG%2FWLCG',viewMode:view) target='_blank'><button class='block'> Information about your host's One-Way Delay</button></a>
  </div>
 </div>
 </div>
